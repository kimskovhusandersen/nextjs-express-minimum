      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img
            ...
            style={{
              width: "100%",
              maxWidth: matchesSM ? 200 : matchesMD ? 700 : 1000
            }}
          />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img
            ...
            style={{
              width: "100%",
              maxWidth: matchesSM ? 200 : matchesMD ? 400 : 1000
            }}
          />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img
            ...
            alt="rocket"
            style={{ width: "100%", maxWidth: matchesMD ? 90 : 200 }}
          />
        </Grid>
      </Grid>
      <Grid
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img
            ...
            style={{ width: "100%", maxWidth: matchesMD ? 200 : 500 }}
          />
        </Grid>
      </Grid>
      <Grid
